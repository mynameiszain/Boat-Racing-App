...
const UserDetailScreen = ({route, navigation}) => {
  ...
  useEffect(() => {
    ...
    const checkRequestStatus = async () => {
      ...
      try {
        const response = await fetch(
          `https://amanda.capraworks.com/api/check_friend_request_status.php?sender_id=${loggedInUserId}&receiver_id=${userId}`,
        );
    ...
    const checkIfRequestSent = async () => {
      ...
      try {
        const response = await fetch(
          `https://amanda.capraworks.com/api/get_outgoing_requests.php?sender_id=${loggedInUserId}&receiver_id=${userId}`,
        );
        const data = await response.json();
    ...
    const fetchUserDetail = async () => {
      try {
        const response = await fetch(
          `https://amanda.capraworks.com/api/userDetail.php?user_id=${userId}`,
        );
  ...
  const sendRequest = async () => {
    ...
    try {
      const response = await fetch(
        `https://amanda.capraworks.com/api/send_friend_request.php?sender_id=${loggedInUserId}&receiver_id=${userDetail.id}`,
      );
      const text = await response.text();
      try {
        const data = JSON.parse(text);
  ...
  >
      <ScrollView>
        ...
        <Image
          source={{
            uri: `https://amanda.capraworks.com/api/${userDetail.cover_image}`,
          }}
        ...
        <View style={styles.container}>
          <View style={styles.innerfContainer}>
            <Image
              source={{
                uri: `https://amanda.capraworks.com/api/${userDetail.user_image}`,
              }}
